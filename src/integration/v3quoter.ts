...
export class V3Quoter {
  ...
  async quoteExactInputSingle(
    ...
    return toBN(await this.contract.quoteExactInputSingle(tokenIn, tokenOut, fee, amountIn, sqrtPriceLimitX96))
  }
  ...
  async quoteExactOutputSingle(
    ...
    return toBN(await this.contract.quoteExactOutputSingle(tokenIn, tokenOut, fee, amountOut, sqrtPriceLimitX96))
  }
}
